...
`;function ae(e){if(e.getElementById("pour-lens-styles"))return;let t=e.createElement("style");t.id="pour-lens-styles",t.dataset.pourAudit="overlay",t.textContent=fe,e.head.appendChild(t)}function J(e=document){let t=e.defaultView,i={contentVisibilityAuto:!0,visibilityProperty:!0,checkVisibilityCSS:!0};function y(u){for(let p=u;p&&p!==e.documentElement;p=p.parentElement??p.getRootNode()?.host??null){let b=p.ownerDocument.defaultView.getComputedStyle(p).position;if(b==="fixed")return"fixed";if(b==="sticky")return"sticky"}return"flow"}function D(u,{withLine:p=!1}={}){let b="background:none;border:0;margin:0;padding:0;box-shadow:none;filter:none;opacity:1;mix-blend-mode:normal;",c=e.createElement("div");c.className=u,c.dataset.pourAudit="overlay",c.style.cssText=`position:absolute;top:0;left:0;width:0;height:0;overflow:clip;overflow-clip-margin:24px;pointer-events:none;z-index:2147483646;${b}`;let o=e.createElement("div");o.className=u,o.dataset.pourAudit="overlay",o.style.cssText=`position:fixed;top:0;left:0;width:0;height:0;overflow:visible;pointer-events:none;z-index:2147483646;${b}`;let w=0,T=0,C=null,P=null,I=null;if(p){P=e.createElementNS("http://www.w3.org/2000/svg","svg"),P.setAttribute("class",`${u.replace(/-layer$/,"")}-path`);for(let[n,h]of[["position","absolute"],["top","0"],["left","0"],["width","100%"],["height","100%"],["max-width","none"],["max-height","none"],["display","block"],["overflow","visible"],["pointer-events","none"],["background","none"],["border","0"],["margin","0"],["padding","0"],["box-shadow","none"],["filter","none"],["opacity","1"],["mix-blend-mode","normal"]])P.style.setProperty(n,h,"important");I=e.createElementNS("http://www.w3.org/2000/svg","polyline"),C=e.createElementNS("http://www.w3.org/2000/svg","polyline");for(let[n,h,m]of[[I,"rgba(29,78,216,0.85)","3"],[C,"#93C5FD","1.5"]])for(let[v,H]of[["fill","none"],["stroke",h],["stroke-width",m],["stroke-linejoin","round"],["stroke-linecap","round"],["filter","none"],["opacity","1"],["mix-blend-mode","normal"]])n.style.setProperty(v,H,"important");P.append(I,C),c.append(P)}let F=[],f=null,S=0,E=(n,h)=>{let m=n.el.getBoundingClientRect(),v=m.width<=0&&m.height<=0||!n.el.isConnected||n.el.checkVisibility&&!n.el.checkVisibility(i);if(n.node.style.display=v?"none":"",v){n.docPt=null,n.viewRect=null;return}let H=n.anchor==="flow"?m.left-h.left:m.left,V=n.anchor==="flow"?m.top-h.top:m.top;n.node.style.transform=`translate(${H}px, ${V}px)`,n.sized&&(n.node.style.width=`${m.width}px`,n.node.style.height=`${m.height}px`),n.anchor==="flow"?n.docPt=`${H},${V}`:n.viewRect=m},x=n=>{if(!C)return;let h=[];for(let v of F)v.offLine||v.node.style.display==="none"||(v.anchor==="flow"?v.docPt&&h.push(v.docPt):v.viewRect&&h.push(`${v.viewRect.left-n.left},${v.viewRect.top-n.top}`));let m=h.join(" ");I.setAttribute("points",m),C.setAttribute("points",m)},d=()=>{let n=e.documentElement.scrollWidth,h=e.documentElement.scrollHeight;n!==w&&(w=n,c.style.width=`${n}px`),h!==T&&(T=h,c.style.height=`${h}px`);let m=c.getBoundingClientRect();for(let v of F)E(v,m);x(m)};e.body.append(c,o);let l=()=>{S=t.requestAnimationFrame(l),d()};return l(),{setItems(n,h){for(let m of F)m.node.remove();F=n.map(m=>{let v=y(m.el);return(v==="flow"?c:o).append(m.node),{...m,anchor:v,docPt:null,viewRect:null}}),h&&!F.length?(f||(f=e.createElement("div"),f.className="pour-lens-notice",o.append(f)),f.textContent=h,f.style.display=""):f&&(f.style.display="none"),d()},destroy(){t.cancelAnimationFrame(S),c.remove(),o.remove(),F=[]}}}function M(u,p){for(let b=u.parentElement??u.getRootNode()?.host;b&&b!==e.documentElement;b=b.parentElement??b.getRootNode()?.host){let c=b.ownerDocument.defaultView.getComputedStyle(b);if(c.overflow==="visible"&&c.overflowX==="visible"&&c.overflowY==="visible")continue;let o=b.getBoundingClientRect();if(p.right<=o.left||p.left>=o.right||p.bottom<=o.top||p.top>=o.bottom)return!0}return!1}function A(){let u=[],p=[],b=c=>{for(let o of c.querySelectorAll("*")){if(o.dataset&&o.dataset.pourAudit||(o.shadowRoot&&b(o.shadowRoot),!o.matches('a[href], area[href], button, input, select, textarea, summary, iframe, object, embed, audio[controls], video[controls], [contenteditable]:not([contenteditable="false"]), [tabindex]'))||o.disabled||o.closest("[inert]")||o.checkVisibility&&!o.checkVisibility(i))continue;let w=o.getBoundingClientRect();if(w.width<=0&&w.height<=0)continue;let T=o.getAttribute("tabindex"),C=T==null?0:parseInt(T,10)||0;if(C<0){o.matches("a[href], area[href], button, input, select, textarea, summary")&&!M(o,w)&&p.push({el:o});continue}u.push({el:o,idx:C,order:u.length})}};return b(e),{stops:[...u.filter(c=>c.idx>0).sort((c,o)=>c.idx-o.idx||c.order-o.order),...u.filter(c=>c.idx===0)],unreachable:p}}return{createLensTracker:D,collectFocusStops:A,clippedOutOfSight:M,VISIBLE_OPTS:i,anchorKind:y}}function he(e=document,t=J(e)){let i=e.defaultView,{createLensTracker:y,collectFocusStops:D,VISIBLE_OPTS:M}=t,A=null,u=0,p=null;function b(){if(A)return;ae(e),A=y("pour-focus-order-layer",{withLine:!0});let f=()=>{let{stops:S,unreachable:E}=D(),x=S.map((d,l)=>{let n=e.createElement("span");return n.className="pour-focus-badge"+(d.idx>0?" pour-focus-badge-forced":""),n.textContent=String(l+1),d.idx>0&&(n.title=`tabindex="${d.idx}" forces this position`),{el:d.el,node:n,sized:!1}});for(let{el:d}of E){let l=e.createElement("span");l.className="pour-focus-badge pour-focus-badge-unreachable",l.textContent="\u2715",l.title='tabindex="-1" \u2014 a keyboard cannot Tab to this control',x.push({el:d,node:l,sized:!1,offLine:!0})}A.setItems(x,"Focus order: this page has no keyboard-reachable controls")};f(),p=new i.MutationObserver(()=>{u||(u=i.setTimeout(()=>{u=0,f()},400))}),p.observe(e.documentElement,{childList:!0,subtree:!0,attributes:!0})}function c(){i.clearTimeout(u),u=0,p?.disconnect(),p=null,A?.destroy(),A=null}let o=null,w=0,T=null;function C(f){let S=f.getAttribute("aria-label");if(S?.trim())return S.trim();let E=f.getAttribute("aria-labelledby");return E?E.split(/\s+/).map(x=>f.getRootNode().getElementById?.(x)?.textContent.trim()??"").filter(Boolean).join(" "):""}function P(){let f=[],S=[],E=d=>{for(let l of d.querySelectorAll("*")){if(l.dataset&&l.dataset.pourAudit||(l.shadowRoot&&E(l.shadowRoot),l.checkVisibility&&!l.checkVisibility(M)))continue;let n=l.getBoundingClientRect();if(n.width<=0&&n.height<=0)continue;let h=te(l);if(be.has(h)){if(h==="form"&&!C(l))continue;f.push({el:l,role:h,name:C(l)})}else if(h==="heading"){let m=parseInt(l.getAttribute("aria-level"),10)||parseInt(l.tagName.charAt(1),10)||2;S.push({el:l,level:m})}}};E(e);let x=null;for(let d of S)d.skipped=x!=null&&d.level>x+1,d.from=x,x=d.level;return{landmarks:f,headings:S}}function I(){if(o)return;ae(e),o=y("pour-map-layer");let f=()=>{let{landmarks:S,headings:E}=P(),x=[];for(let d of S){let l=e.createElement("div");l.className=`pour-map-region pour-map-role-${d.role}`;let n=e.createElement("span");n.className="pour-map-tag",n.textContent=d.name?`${d.role} \xB7 ${d.name}`:d.role,l.append(n),x.push({el:d.el,node:l,sized:!0})}for(let d of E){let l=e.createElement("span");l.className="pour-map-heading"+(d.skipped?" pour-map-heading-skipped":""),l.textContent=`H${d.level}`,d.skipped&&(l.title=`Skips a level \u2014 the heading before this one is an H${d.from}`),x.push({el:d.el,node:l,sized:!1})}o.setItems(x,"No landmarks or headings are exposed on this page")};f(),T=new i.MutationObserver(()=>{w||(w=i.setTimeout(()=>{w=0,f()},400))}),T.observe(e.documentElement,{childList:!0,subtree:!0,attributes:!0})}function F(){i.clearTimeout(w),w=0,T?.disconnect(),T=null,o?.destroy(),o=null}return{focusOrder:{apply:b,remove:c},landmarkMap:{apply:I,remove:F}}}var ve=`/* Overlay styles for the vision & sensory filters \u2014 ported from
...
`;function ye(e=document){let t=e.defaultView,i=e.documentElement,y=J(e),D=he(e,y),M=null,A=null,u="none",p="none",b=0,c=0,o=0,w=0,T=null;function C(){if(e.getElementById("pour-filter-styles"))return;let a=e.createElement("style");a.id="pour-filter-styles",a.dataset.pourAudit="filter",a.textContent=ve,e.head.appendChild(a)}function P(){if(e.getElementById("pour-vision-filter-defs"))return;let a="http://www.w3.org/2000/svg",r=e.createElementNS(a,"svg");r.setAttribute("id","pour-vision-filter-defs"),r.setAttribute("width","0"),r.setAttribute("height","0"),r.setAttribute("focusable","false"),r.setAttribute("aria-hidden","true"),r.dataset.pourAudit="filter",r.style.position="absolute",r.style.pointerEvents="none";let s=e.createElementNS(a,"defs");for(let[L,R]of Object.entries(Q)){let k=e.createElementNS(a,"filter");k.setAttribute("id",`pour-vision-filter-${L}`),k.setAttribute("color-interpolation-filters","linearRGB");let g=e.createElementNS(a,"feColorMatrix");g.setAttribute("type","matrix"),g.setAttribute("values",R),k.appendChild(g),s.appendChild(k)}r.appendChild(s),e.body.appendChild(r)}let I=a=>{let r=e.createElement("div");return r.className=a,r.dataset.pourAudit="filter",e.body.appendChild(r),r};function F(){o=0,i.style.setProperty("--pour-vision-x",`${b}px`),i.style.setProperty("--pour-vision-y",`${c}px`),i.style.setProperty("--pour-vision-r",`${Math.min(t.innerWidth,t.innerHeight)}px`)}function f(a){b=a.clientX,c=a.clientY,o||(o=t.requestAnimationFrame(F))}function S(a){let r=a.touches[0];r&&f(r)}function E(a){for(let s of Z)i.classList.remove(`pour-vision-filter-${s}`);if(ee.has(u)&&(e.removeEventListener("mousemove",f),e.removeEventListener("touchmove",S)),M?.remove(),M=null,u=B[a]!==void 0?a:"none",u==="none"){p==="none"&&(i.style.filter="");return}p!=="none"&&K("none"),C(),P();let r=B[u]||"none";i.style.filter=r==="none"?"":r,Z.has(u)&&(i.classList.add(`pour-vision-filter-${u}`),M=I("pour-vision-filter-overlay"),M.dataset.filter=u),ee.has(u)&&(b=t.innerWidth/2,c=t.innerHeight/2,F(),e.addEventListener("mousemove",f),e.addEventListener("touchmove",S,{passive:!0}))}function x(){w=0,i.style.setProperty("--pour-sensory-x",`${b}px`),i.style.setProperty("--pour-sensory-y",`${c}px`),i.style.setProperty("--pour-sensory-r",`${Math.min(t.innerWidth,t.innerHeight)}px`)}function d(a){b=a.clientX,c=a.clientY,w||(w=t.requestAnimationFrame(x))}function l(a){let r=a.touches[0];r&&d(r)}function n(a){if(e.getElementById("pour-sensory-injected-style")?.remove(),!a)return;let r=e.createElement("style");r.id="pour-sensory-injected-style",r.dataset.pourAudit="filter",r.textContent=a,e.head.appendChild(r)}function h(){if(e.querySelector(".pour-sensory-washout-char"))return;let a=e.createTreeWalker(e.body,NodeFilter.SHOW_TEXT,null),r=[];for(;a.nextNode();)r.push(a.currentNode);for(let s of r){let L=s.textContent;if(!L.trim())continue;let R=s.parentElement;if(!R||R.closest("script,style,noscript,[data-pour-audit]"))continue;let k=e.createDocumentFragment();for(let g of L)if(g===" "||g===`
`||g==="	")k.appendChild(e.createTextNode(g));else{let O=e.createElement("span");O.textContent=g,O.style.opacity=(.3+Math.random()*.7).toFixed(2),O.className="pour-sensory-washout-char",k.appendChild(O)}R.replaceChild(k,s)}}function m(){for(let a of e.querySelectorAll(".pour-sensory-washout-char"))a.replaceWith(a.textContent);e.body.normalize()}let v=[[0,0],[0,18],[4.5,13.8],[7.2,19.5],[9.9,18.4],[7.3,12.9],[13,12.9]],H=new Map,V=0,ne=0,X=null,ie=0,oe=0,_=0,Y=0,$=0,G=0;function xe(a,r,s){let L=`${a}:${r}:${s}`,R=H.get(L);if(R)return R;let k=e.createElement("canvas");k.width=a,k.height=a;let g=k.getContext("2d");if(!g)return"auto";let O=Math.round(a/2);g.save(),g.translate(O+r,O+s),g.scale(1.15,1.15),g.beginPath(),g.moveTo(v[0][0],v[0][1]);for(let q=1;q<v.length;q++)g.lineTo(v[q][0],v[q][1]);g.closePath(),g.restore(),g.lineWidth=3,g.lineJoin="round",g.strokeStyle="#fff",g.stroke(),g.fillStyle="#000",g.fill();let N=`url("${k.toDataURL("image/png")}") ${O} ${O}, auto`;return H.set(L,N),N}function se(a){let r=a.timeStamp||Date.now(),s=r-_;if(_&&s>0){let L=Math.hypot(a.clientX-ie,a.clientY-oe);Y=Y*.8+L/s*1e3*.2}ie=a.clientX,oe=a.clientY,_=r}function ke(a,r){if(!$)return $=a+r.minGap+Math.random()*(r.maxGap-r.minGap),[0,0];let s=a-$;if(s<0)return[0,0];if(s>r.dur)return $=a+r.minGap+Math.random()*(r.maxGap-r.minGap),G=Math.random()*Math.PI*2,[0,0];let L=1-s/r.dur,R=r.size*L*L;return[Math.cos(G)*R,Math.sin(G)*R]}function le(a){V=t.requestAnimationFrame(le);let r=X;if(!r)return;let s=(a-ne)/1e3,L=0,R=0;if(r.freq&&r.amp){let N=2*Math.PI*r.freq,q=Math.max(0,1+(r.intent||0)*Math.min(1,Y/700)),me=r.amp*q;L+=(Math.sin(N*s)*.7+Math.sin(N*1.63*s+1.1)*.3)*me,R+=(Math.cos(N*.97*s+.6)*.7+Math.sin(N*2.11*s+2.3)*.3)*me}if(r.spasm){let[N,q]=ke(a,r.spasm);L+=N,R+=q}let k=r.bitmap/2-14,g=Math.max(-k,Math.min(k,Math.round(L))),O=Math.max(-k,Math.min(k,Math.round(R)));i.style.cursor=xe(r.bitmap,g,O)}function we(a){pe(),X=a,ne=t.performance?t.performance.now():Date.now(),Y=0,_=0,$=0,G=Math.random()*Math.PI*2,de(a.hide?`
    ...
    `:`
      ...
      [data-pour-audit], [data-pour-audit] * { cursor: auto !important; }
    `),!a.hide&&(e.addEventListener("mousemove",se,{passive:!0}),V=t.requestAnimationFrame(le))}function pe(){V&&t.cancelAnimationFrame(V),V=0,X=null,$=0,e.removeEventListener("mousemove",se),de(null),i.style.cursor=""}function de(a){if(e.getElementById("pour-sensory-cursor-style")?.remove(),!a)return;let r=e.createElement("style");r.id="pour-sensory-cursor-style",r.dataset.pourAudit="filter",r.textContent=a,e.head.appendChild(r)}function Se(){ce();let a=()=>{T=t.setTimeout(()=>{A&&(A.classList.add("pour-sensory-spike-flash"),t.setTimeout(()=>{A?.classList.remove("pour-sensory-spike-flash"),a()},150))},3e3+Math.random()*8e3)};a()}function ce(){T&&(t.clearTimeout(T),T=null)}function K(a){let r=z[p];if(r?.overlay&&i.classList.remove(`pour-sensory-filter-${p}`),r?.hostClass&&i.classList.remove(r.hostClass),r?.mouseTracked&&(e.removeEventListener("mousemove",d),e.removeEventListener("touchmove",l)),r?.injectScript&&m(),r?.cursorJitter&&pe(),r?.viewportOrigin&&Ae(),r?.lens&&D[r.lens]?.remove(),ce(),A?.remove(),A=null,n(null),p=z[a]?a:"none",p==="none"){u==="none"&&(i.style.filter="");return}u!=="none"&&E("none"),C();let s=z[p];i.style.filter=s.css&&s.css!=="none"?s.css:"",s.hostClass&&i.classList.add(s.hostClass),(s.overlay||s.mouseTracked||p==="sensorySpike")&&(A=I("pour-sensory-filter-overlay"),A.dataset.filter=p,s.overlay&&i.classList.add(`pour-sensory-filter-${p}`)),s.mouseTracked&&(b=t.innerWidth/2,c=t.innerHeight/2,x(),e.addEventListener("mousemove",d),e.addEventListener("touchmove",l,{passive:!0})),s.injectCSS&&n(s.injectCSS),p==="sensorySpike"&&Se(),s.injectScript&&h(),s.cursorJitter&&we(s.cursorJitter),s.viewportOrigin&&Le(),s.lens&&D[s.lens]?.apply()}let j=0;function ue(){j=0,i.style.setProperty("--pour-motion-origin",`${t.scrollX+t.innerWidth/2}px ${t.scrollY+t.innerHeight/2}px`)}function W(){j||(j=t.requestAnimationFrame(ue))}function Le(){ue(),t.addEventListener("scroll",W,{passive:!0}),t.addEventListener("resize",W)}function Ae(){t.removeEventListener("scroll",W),t.removeEventListener("resize",W),j&&(t.cancelAnimationFrame(j),j=0),i.style.removeProperty("--pour-motion-origin")}let Te=()=>({vision:u,sensory:p});function Ee(){E("none"),K("none")}return{applyVision:E,applySensory:K,clear:Ee,state:Te}}return Me(Ke);})();
